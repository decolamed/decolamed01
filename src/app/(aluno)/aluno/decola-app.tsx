...
interface DecolaAppProps {
  ...
  // Modo demonstração — usado pela vitrine /preview-aluno (admin/parceiro
  // vendo o app sem ser aluno de verdade). Quando true, todas as gravações
  // reais (respostas de questões, flashcard revisões, simulados, relatos)
  // são suprimidas silenciosamente.
  demoMode?: boolean;
  alunoId?: string;
