...
async function criarPlano(formData: FormData) {
  ...
  // A configuração de parcelamento é validada ANTES de tocar no banco: as
  // CHECKs de `planos` recusariam o mesmo, mas como exceção de constraint —
  // e o admin leria "não foi possível criar o plano" sem saber o que corrigir.
        ...
        <form action={criarPlano} className="mt-4 space-y-4">
          ...
          <fieldset className="rounded-xl border border-navy/10 bg-navy/5 p-4">
            ...
            <label className="flex items-center gap-2 text-sm">
              <input type="checkbox" name="parcelamento_ativo" defaultChecked={false} />
              <span>
            ...
            <label className="mt-3 flex items-center gap-2 text-sm">
              <input type="checkbox" name="juros_ativo" defaultChecked={false} />
              <span>
